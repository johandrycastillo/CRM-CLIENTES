...
export default function App(){
  ...
  const fetchData=async()=>{
    try{
      ...
      // ddByName / ddByNit arrancan vacíos y se llenan ÚNICAMENTE con lo que
      // llega del fetch en vivo a Google Sheets. Si una empresa no está en el
      // Sheet ahora mismo, no debe aparecer con datos de DD en el CRM.
      const ddByName={};
      const ddByNit={};
      ...
      if(liveCount===0){
        console.warn("⚠️ DD CLIENTES POTENCIALES: 0 empresas cargadas en vivo. ddT length:",ddT.length);
      }
